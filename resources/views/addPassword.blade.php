...
<div class="container-fluid">
    ...
    <div class="box box-bordered">
        ...
        <div class="box-content nopadding">
            <form action="{{route('passwords.store')}}" method="POST" class="form-horizontal form-bordered">
                @csrf
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" name="login" id="login" placeholder="Text input" class="input-xlarge">
                    </div>
                </div>
                <div class="control-group">
                    <label for="pass" class="control-label">pass</label>
                    <div class="controls">
                        <input type="text" name="pass" id="pass" placeholder="Text input" class="input-xlarge">
                    </div>
                </div>
                <div class="control-group">
                    <label for="url" class="control-label">url</label>
                    <div class="controls">
                        <input type="text" name="url" id="url" placeholder="Text input" class="input-xlarge">
                    </div>
                </div>
