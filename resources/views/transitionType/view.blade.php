...
@section('title', 'Transação tipo / visualizar')
        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <h5>Transação tipo: visualizar</h5>
                ...
                <div class="ibox-content">
                    <form action="" method="POST" class="form-horizontal form-bordered">
                        <div class="form-group  row"><label class="col-sm-2 col-form-label">Título</label>
                            <div class="col-sm-10">
                                <input type="text" name="title" id="title" value="{{$transitionType->title}}" class="form-control" tabindex="1">
                            </div>
                        </div>
                        ...
                        <div class="form-group  row"><label class="col-sm-2 col-form-label">Descrição</label>
                            <div class="col-sm-10">
                                <textarea id="content" name="description">{{$transitionType->description}}</textarea>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="i-checks"><label> <input type="checkbox" name="credit_card" id="credit_card" value="true" tabindex="6" {{$transitionType->credit_card == true ? 'checked' : ''}}> <i></i> Cartão de crédito </label></div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4 col-sm-offset-2">
                                <a href="{{route('transitionTypes.index')}}" class="btn btn-white btn-sm">Voltar</a>
                            </div>
                        </div>
