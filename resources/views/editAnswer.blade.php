...
<div class="container-fluid">
    ...
    <div class="box box-bordered">
        ...
        <div class="box-content nopadding">
            <form action="{{route('answers.update', ['answer' => $answer->id])}}" method="POST" class="form-horizontal form-bordered">
                @csrf
                @method('PUT')
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <textarea name="description" id="description" rows="5" class="input-block-level">{{$answer->description}}</textarea>
                    </div>
                </div>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <div class="check-demo-col">
                            <div class="check-line">
                                <input type="checkbox" id="correct" name="correct" value="true" class='icheck-me' data-skin="square" data-color="blue" {{$answer->correct == true ? 'checked' : ''}}> <label class='inline' for="c9">Resosta correta</label>
                            </div>
                        </div>
                    </div>
                </div>
