...
<div class="container-fluid">
    ...
    <div class="box box-bordered">
        ...
        <div class="box-content nopadding">
            ...
            <form id="file-upload-form" class="form-horizontal form-bordered" action="{{route('questionImages.store')}}" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                @csrf
                ...
                <tbody>
                    @foreach ($question->images as $value)
                        <tr>
                            ...
                            <td>
                                <form action="{{route('questionImages.destroy', ['questionImage' => $value->id])}}" method="POST" onSubmit="return confirm('Deseja excluir?');" style="padding: 0px;margin:0px;">
                                    @csrf
                                    @method('delete')
