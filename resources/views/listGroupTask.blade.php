        ...
        <div class="box-content nopadding">
            <form action="{{route('groupTasks.update', ['groupTask' => $groupTask->id])}}" method="POST" class="form-horizontal form-bordered">
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" name="title" id="title" value="{{$groupTask->title}}" placeholder="Text input" class="input-xlarge" disabled>
                    </div>
                </div>
                <div class="control-group">
                    <label for="content" class="control-label">Conteúdo</label>
                    <div class="controls">
                        <textarea name="content" id="content" rows="5" class="input-block-level" disabled>{{$groupTask->content}}</textarea>
                    </div>
                </div>
