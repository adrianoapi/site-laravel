        ...
        <div class="box-content nopadding">
            <form action="{{route('ledgerEntries.store')}}" method="POST" class="form-horizontal form-bordered">
                    ...
                    <div class="controls">
                        <select name="ledger_group_id" id="ledger_group_id" class="select2-me input-xlarge">
                            @foreach ($ledgerGroups as $value)
                                <option value="{{$value->id}}" {{$value->id == $value->ledger_group_id ? 'disabled' : ''}}>{{$value->id == $value->ledger_group_id ? '== '.$value->title.' ==' : $value->title}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" name="entry_date" id="entry_date" class="input-medium datepick">
                    </div>
                </div>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <div class="input-prepend">
                            ...
                            <input type="text" name="amount" id="amount" placeholder="0,00" class="input-small">
                        </div>
                    </div>
                </div>
