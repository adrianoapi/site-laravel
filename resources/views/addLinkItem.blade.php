...
<div class="container-fluid">
    ...
    <div class="box box-bordered box-color">
        ...
        <div class="box-content nopadding">
            <form action="{{route('linksItems.store')}}" method="POST" class="form-horizontal form-bordered">
                @csrf
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" name="url" id="url" placeholder="Password input" class="input-xlarge">
                    </div>
                </div>
                <div class="control-group">
