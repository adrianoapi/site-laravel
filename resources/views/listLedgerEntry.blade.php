        ...
        <div class="box-content nopadding">
            <form action="" method="POST" class="form-horizontal form-bordered">
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" name="description" id="description" value="{{$ledgerEntry->description}}" placeholder="Text input" class="input-xxlarge" disabled>
                    </div>
                </div>
                <div class="control-group">
                    <label for="ledger_group_id" class="control-label">Tipo de Despesa</label>
                    <div class="controls">
                        <select name="ledger_group_id" id="ledger_group_id" class="select2-me input-xlarge" disabled>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select name="transition_type_id" id="transition_type_id" class="select2-me input-xlarge" disabled>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" name="entry_date" id="entry_date" value="{{$ledgerEntry->entry_date}}" class="input-medium datepick" disabled>
                    </div>
                </div>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <div class="input-prepend">
                            ...
                            <input type="text" name="amount" id="amount" value="{{$ledgerEntry->amount}}" placeholder="0,00" class="input-small" disabled>
                        </div>
                    </div>
                </div>
                <div class="form-actions">
                    <a href="{{route('ledgerEntries.index')}}" class="btn">Voltar</a>
                </div>
            </form>
        </div>
    </div>
